  ...
  return (
    <GDPRWrapper>
      <StyledFlexDiv justify="flex-start" align="flex-start">
        <StyledMediumHeading textAlign="left">GDPR</StyledMediumHeading>
        ...
        <StyledParagraph textAlign="left" padding="10px 0px" fontSize="1.6rem">
          ...
          processing of personal data on this website. Information on how to
          contact us is available under the link Contact at the top of the page.
        </StyledParagraph>
        <StyledParagraph textAlign="left" padding="10px 0px" fontSize="1.6rem">
          By “personal data” is meant all information that can be linked
        ...
        <StyledParagraph textAlign="left" padding="10px 0px" fontSize="1.6rem">
          ...
          for what purposes we treat your Personal Information. By submitting
          your Personal Information to us and accepting the applicable terms,
          you agree that your Personal Information will be processed in
          accordance with what is stated in this Privacy Policy. If the law
          requires a more specific consent from you, we will naturally ask for
          one.
        </StyledParagraph>
        <StyledParagraph textAlign="left" padding="10px 0px" fontSize="1.6rem">
        ...
        <StyledParagraph textAlign="left" padding="10px 0px" fontSize="1.6rem">
          Through this Privacy Policy you also consent to the use of information
          / registration information in order to identify your target audience
          ...
          written application at jag's space, to receive information about which
        ...
        <StyledParagraph textAlign="left" padding="10px 0px" fontSize="1.6rem">
          ...
          errors, optimize the technology and be able to contact you in case of
          problems with a booking or execution of the Services, analyze and
          improve the quality and experience of the Services, analyze statistics
          and user behavior regarding our Services, increase your benefit and
          experience of our Services in other ways we think you would
          appreciate, or promote services and products, directly or not,
        ...
        <StyledParagraph textAlign="left" padding="10px 0px" fontSize="1.6rem">
          When you make a reservation with us, we use your personal information
          to send booking confirmation, important information about the upcoming
          reservation. Such mailings will be sent to the email address you
        ...
        <StyledParagraph textAlign="left" padding="10px 0px" fontSize="1.6rem">
          The same personal data can be stored in several different places for
          different purposes. This may mean that a task that has been culled
          from a system because it is no longer necessary may remain in another
          system where it is stored with the support of consent or for another
        ...
        <StyledSmallHeading padding="10px 0px">
          Technical / organizational measures for safe treatment of personal
          data
        </StyledSmallHeading>
        <StyledParagraph textAlign="left" padding="10px 0px" fontSize="1.6rem">
